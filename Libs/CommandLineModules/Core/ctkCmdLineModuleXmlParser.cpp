...
void ctkCmdLineModuleXmlParser::handleExecutableElement()
{
  while(_xmlReader.readNextStartElement())
  {
    ...
    else if (name.compare(QStringLiteral("title"), Qt::CaseInsensitive) == 0)
    {
      _md->d->Title = _xmlReader.readElementText().trimmed();
    }
    else if (name.compare(QStringLiteral("version"), Qt::CaseInsensitive) == 0)
    {
      _md->d->Version = _xmlReader.readElementText().trimmed();
    }
    else if (name.compare(QStringLiteral("documentation-url"), Qt::CaseInsensitive) == 0)
    {
      _md->d->DocumentationURL = _xmlReader.readElementText().trimmed();
    }
    else if (name.compare(QStringLiteral("license"), Qt::CaseInsensitive) == 0)
    {
      _md->d->License = _xmlReader.readElementText().trimmed();
    }
    else if (name.compare(QStringLiteral("acknowledgements"), Qt::CaseInsensitive) == 0)
    {
      _md->d->Acknowledgements = _xmlReader.readElementText().trimmed();
    }
    else if (name.compare(QStringLiteral("contributor"), Qt::CaseInsensitive) == 0)
    {
    ...
    else if (name.compare(QStringLiteral("parameters"), Qt::CaseInsensitive) == 0)
    {
...
void ctkCmdLineModuleXmlParser::handleParametersElement()
{
  ...
  while(_xmlReader.readNextStartElement())
  {
    ...
    if (name.compare(QStringLiteral("label"), Qt::CaseInsensitive) == 0)
    {
