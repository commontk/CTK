...
{
  if (attrValue.compare(QStringLiteral("true"), Qt::CaseInsensitive) == 0 ||
      attrValue.compare(QStringLiteral("1")) == 0)
  {
    return true;
  }
  return false;
...
protected:
  ...
  virtual bool handleSubElement(ctkCmdLineModuleParameterPrivate* moduleParamPrivate, QXmlStreamReader& xmlReader)
  {
    ...
    if (name.compare(QStringLiteral("name"), Qt::CaseInsensitive) == 0)
    {
      moduleParamPrivate->Name = xmlReader.readElementText().trimmed();
    }
    else if (name.compare(QStringLiteral("description"), Qt::CaseInsensitive) == 0)
    {
      moduleParamPrivate->Description = xmlReader.readElementText().trimmed();
    }
    else if (name.compare(QStringLiteral("label"), Qt::CaseInsensitive) == 0)
    {
    ...
    else if (name.compare(QStringLiteral("flag"), Qt::CaseInsensitive) == 0)
    {
    ...
    else if (name.compare(QStringLiteral("longflag"), Qt::CaseInsensitive) == 0)
    {
    ...
    else if (name.compare(QStringLiteral("index"), Qt::CaseInsensitive) == 0)
    {
      moduleParamPrivate->Index = xmlReader.readElementText().toInt();
    }
    else if (name.compare(QStringLiteral("channel"), Qt::CaseInsensitive) == 0)
    {
  ...
  bool handleConstraintsElement(ctkCmdLineModuleParameterPrivate* moduleParamPrivate, QXmlStreamReader& xmlReader)
  {
    ...
    while(xmlReader.readNextStartElement())
    {
      ...
      if (constraintElem.compare(QStringLiteral("minimum"), Qt::CaseInsensitive) == 0)
      {
        moduleParamPrivate->Minimum = xmlReader.readElementText().trimmed();
      }
      else if (constraintElem.compare(QStringLiteral("maximum"), Qt::CaseInsensitive) == 0)
      {
        moduleParamPrivate->Maximum = xmlReader.readElementText().trimmed();
      }
      else if (constraintElem.compare(QStringLiteral("step"), Qt::CaseInsensitive) == 0)
      {
...
protected:
  ...
  bool handleSubElement(ctkCmdLineModuleParameterPrivate* moduleParamPrivate, QXmlStreamReader& xmlReader)
  {
    ...
    if (name.compare(QStringLiteral("constraints"), Qt::CaseInsensitive) == 0)
    {
...
protected:
  ...
  bool handleSubElement(ctkCmdLineModuleParameterPrivate* moduleParamPrivate, QXmlStreamReader& xmlReader)
  {
    ...
    if (name.compare(QStringLiteral("element"), Qt::CaseInsensitive) == 0)
    {
