...
public:
  ...
  Q_INVOKABLE virtual void associateStepWithLabel(ctkWorkflowStep* step, const QString& label);
  ...
  Q_INVOKABLE virtual void associateStepWithPage(ctkWorkflowStep* step, int index, const QString& label);
