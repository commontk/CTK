...
//-----------------------------------------------------------------------------
int ctkErrorLogStatusMessageHandlerEventTranslatorPlayerTest1(int argc, char * argv [] )
{
  ...
  etpWidget.addTestCase(widget,
                        xmlDirectory + "ctkErrorLogStatusMessageHandlerEventTranslatorPlayerTest1.xml",
