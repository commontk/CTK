...
//-----------------------------------------------------------------------------
int ctkTransferFunctionControlPointsItemEventTranslatorPlayerTest1(int argc, char * argv [] )
{
  ...
  etpWidget.addTestCase(widget,
                        xmlDirectory + "ctkTransferFunctionControlPointsItemEventTranslatorPlayerTest1.xml",
