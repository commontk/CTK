...
//-----------------------------------------------------------------------------
int ctkMaterialPropertyPreviewLabelEventTranslatorPlayerTest1(int argc, char * argv [] )
{
  ...
  etpWidget.addTestCase(widget,
                        xmlDirectory + "ctkMaterialPropertyPreviewLabelEventTranslatorPlayerTest1.xml",
