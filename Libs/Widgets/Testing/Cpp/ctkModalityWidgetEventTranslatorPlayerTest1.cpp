...
//-----------------------------------------------------------------------------
int ctkModalityWidgetEventTranslatorPlayerTest1(int argc, char * argv [] )
{
  ...
  // Test case 1
  ctkModalityWidget* widget = new ctkModalityWidget();
  etpWidget.addTestCase(widget,
                        xmlDirectory + "ctkModalityWidgetEventTranslatorPlayerTest1.xml",
