...
public:
  ...
  void registerEmptyFieldNames(const QMultiMap<QString, QString>& emptyFieldsSeries, const QMultiMap<QString, QString>& emptyFieldstudies, const QMultiMap<QString, QString>& emptyFieldsPatients) override;
...
protected:
  QString humanReadablePatientName(const QString& dicomPatientName);
};
