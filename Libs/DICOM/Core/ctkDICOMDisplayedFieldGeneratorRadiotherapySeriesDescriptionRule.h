...
public:
  ...
  void registerEmptyFieldNames(const QMultiMap<QString, QString>& emptyFieldsSeries, const QMultiMap<QString, QString>& emptyFieldsStudies, const QMultiMap<QString, QString>& emptyFieldsPatients) override;
