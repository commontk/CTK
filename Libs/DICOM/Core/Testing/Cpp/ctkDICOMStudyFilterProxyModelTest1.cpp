...
int ctkDICOMStudyFilterProxyModelTest1(int argc, char* argv[])
{
  ...
  try
  {
    ...
    // Create study model
    ctkDICOMStudyModel sourceModel;
    ...
    CHECK_POINTER(proxyModel.sourceModel(), &sourceModel);
    ...
    // Test sorting (sorts by date/time, most recent first)
