...
//-----------------------------------------------------------------------------
int ctkVTKSurfaceMaterialPropertyWidgetEventTranslatorPlayerTest1(int argc, char * argv [] )
{
  ...
  etpWidget.addTestCase(widget,
                        xmlDirectory + "ctkVTKSurfaceMaterialPropertyWidgetEventTranslatorPlayerTest1.xml",
