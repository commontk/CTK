...
ctkMTLogTracker::ctkMTLogTracker(ctkPluginContext* context, QIODevice* out)
  : ctkServiceTracker<ctkLogService*>(context), out(out), logLevel(std::numeric_limits<int>::max())
{

}

int ctkMTLogTracker::getLogLevel() const
{
  QMutexLocker lock(&mutex);
  return logLevel;
}

ctkLogService* ctkMTLogTracker::addingService(const ctkServiceReference& reference)
{
...
void ctkMTLogTracker::removedService(const ctkServiceReference& reference, ctkLogService* service)
{
...
void ctkMTLogTracker::log(int level, const QString& message, const std::exception* exception,
                          const char* file, const char* function, int line)
{
  logToAll(ctkServiceReference(), level, message, exception, file, function, line);
}

void ctkMTLogTracker::log(const ctkServiceReference& reference, int level, const QString& message,
...
void ctkMTLogTracker::logToAll(const ctkServiceReference& reference, int level, const QString& message,
                               const std::exception* exception, const char* file, const char* function, int line)
{
...
void ctkMTLogTracker::noLogService(const ctkServiceReference& reference, int level, const QString& message,
