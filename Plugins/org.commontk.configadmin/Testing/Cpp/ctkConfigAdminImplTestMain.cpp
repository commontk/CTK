...
int main(int argc, char** argv)
{
  ...
  app.setApplicationName("ctkConfigAdminImplCppTests");
  ...
  testRunner.addPlugin(testpluginDir, "org_commontk_configadmintest");
  testRunner.addPlugin(pluginDir, "org_commontk_configadmin");
  testRunner.addPlugin(pluginDir, "org_commontk_log");
  testRunner.startPluginOnRun("org.commontk.configadmintest");
  ...
  fwProps.insert("cm.impl", "org.commontk.configadmin");
